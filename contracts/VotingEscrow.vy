...
rewards_contract: public(address) # Contract for receiving penalties for pre mature withdrawals
...
def withdraw():
    ...
    locked_value: uint256 = convert(_locked.amount, uint256)
    value_to_receive: uint256 = locked_value
    ...
    supply_before: uint256 = self.supply
    self.supply = supply_before - locked_value
    ...
    log Supply(supply_before, supply_before - locked_value)
